    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              <a 
                href="#projects" 
                className="px-6 py-2 text-sm bg-orange-500 text-white font-semibold rounded-md hover:bg-orange-600 hover:scale-105 transition-all duration-300"
              >
                View My Work
              </a>
              <a 
                href="#contact" 
                className="px-6 py-2 text-sm border-2 border-orange-500 text-orange-500 rounded-md font-semibold hover:bg-orange-50 hover:scale-105 transition-all duration-300"
              >
                Contact Me
              </a>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {skillCategories.map((category, catIndex) => (
              <div
                key={catIndex}
                className={`bg-white rounded-lg p-5 text-center transition-all duration-500 transform hover:scale-105 hover:shadow-lg border border-gray-200 ${
              ...
              >
                ...
                <h3 className="text-base font-bold text-orange-500 mb-3 pb-2 border-b-2 border-orange-200 inline-block">
                  {category.name}
                </h3>
                <div className="flex flex-wrap justify-center gap-2 mt-3">
                  {category.skills.map((skill, skillIndex) => (
                    <span
                      key={skillIndex}
                      className="px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-xs font-medium hover:bg-orange-500 hover:text-white transition-all duration-300 cursor-pointer"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-white rounded-lg overflow-hidden hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300 transform hover:-translate-y-2 border border-gray-200"
              >
                ...
                <div className="p-5">
                  ...
                  <a href={project.link} target="_blank" className="text-orange-500 hover:text-orange-600 font-semibold inline-flex items-center gap-1 text-sm">
                    View Project →
                  </a>
                </div>
              </div>
      ...
      <section id="contact" className="py-16 bg-gray-200">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <a 
            href="mailto:jennifer.montil@example.com" 
            className="inline-block px-6 py-2 text-sm bg-orange-500 text-white font-semibold rounded-md hover:bg-orange-600 hover:scale-105 transition-all duration-300"
          >
            Get In Touch
          </a>
        </div>
